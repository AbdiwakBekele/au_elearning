        ...
        <nav id="sidebar">
                <div class="p-4 pt-5">
                    <ul class="list-unstyled components mb-5">
                       ...
                       <li><a href="s_view_result.php?id=<?php echo  $temp_student_id ?>" class="text-warning"><i class="fas fa-street-view"></i> View Result</a></li>
                                                ...
                                                include '../my_funcs.php';
                                                    ...
                                                    if(isset($_REQUEST['id'])){
                                                        ...
                                                        while ($r = mysqli_fetch_assoc($q_assign_result )){
                                                            ...
                                                            /////// Empty Check quiz Result /////
                                                            if( $r['quiz'] != ""){
                                                                $student_class['quiz'] = $r['quiz'];
                                                            }else{
                                                                $student_class['quiz'] = "- ";
                                                            }

                                                            /////// Empty Check assignment Result /////
                                                            if( $r['assignment'] != ""){
                                                                $student_class['assignment'] = $r['assignment'];
                                                            }else{
                                                                $student_class['assignment'] = " - ";
                                                            }

                                                            /////// Empty Check assignment Result /////
                                                            if( $r['exam'] != ""){
                                                                $student_class['exam'] = $r['exam'];
                                                            }else{
                                                                $student_class['exam'] = " - ";
                                                            }
                                                            ...
                                                            while($row = mysqli_fetch_assoc($q_result)){
                                                                ...
                                                                $number,
                                                                $class_title,
                                                                htmlspecialchars( $student_class['quiz']),
                                                                htmlspecialchars($student_class['assignment']),
                                                                htmlspecialchars($student_class['exam']),
                                                                htmlspecialchars($student_class['total'])
                                                                );
                                                            }
                                                            echo "</tr>";
                                                            $number++;
