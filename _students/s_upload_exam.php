    ...
    <div class="wrapper d-flex align-items-stretch">
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 text-center">
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-street-view"></i> <strong> Submit Exam </strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-12 col-md-8 offset-md-2"> 
                ...
                if(isset($_POST['Submit'])){
                    ...
                    $query = "UPDATE assign SET submitted_exam = '$exam_name' WHERE assign_id = '$assign_id' ";

                    if(mysqli_query($con, $query)){
                        $msg = "You have Successfully Uploaded a Your Exam!<br>";
                        echo $msg;
                ...
                if(isset($_REQUEST['id'])){
                    $assign_id = intval($_REQUEST['id']);
                        ...
                        <form class="was-validated bg-light border shadow p-3" action="s_upload_exam.php" method="POST" enctype="multipart/form-data" name="form">

                                <!-- Upload Assignment  -->
                                <div class="row mt-3">
                                    <div class="form-group col-md-12">
                                        <label for="fullname" class="form-label"><h6><b><i class="fas fa-user"></i> Submit Exam</b></h6></label>
                                        <input type="file" class="form-control" name="class_exam" id="fullname" placeholder="Upload Material" required>
