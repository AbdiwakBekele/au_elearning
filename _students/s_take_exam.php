        ...
        <nav id="sidebar">
                <div class="p-4 pt-5">
                    ...
                    <li><a href="students.php"  ><i class="fas fa-street-view"></i> Profile</a></li>
                       ...
                       <li><a href="s_take_exam.php?id=<?php echo  $temp_student_id ?>" class="text-warning"><i class="fas fa-file-import"></i> Take Exam</a></li>
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 text-center">
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-street-view"></i> <strong> Exams </strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                include '../my_funcs.php';
                                                    ...
                                                    if(isset($_REQUEST['id'])){
                                                        ...
                                                        while ($r = mysqli_fetch_assoc($q_assign_result )){
                                                            ...
                                                            $temp_assign_id = $student_class['assign_id'];
                                                            ...
                                                            while($row = mysqli_fetch_assoc($q_result)){
                                                                ...
                                                                <td class="text-center h4">
                                                                    <a href="s_download_exam.php?id=<?php echo $row['class_id']; ?>"><i class="fas fa-download px-3"></i></a>
                                                                </td>

                                                                <td class="text-center h4">
                                                                    <a href="s_upload_exam.php?id=<?php echo $temp_assign_id; ?>"><i class="fas fa-upload px-3"></i></a>
                                                                </td>
