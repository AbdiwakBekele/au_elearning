        ...
        <nav id="sidebar">
                <div class="p-4 pt-5">
                    ...
                    <li><a href="students.php"  ><i class="fas fa-street-view"></i> Profile</a></li>
                       ...
                       <li><a href="s_available_materials.php?id=<?php echo  $temp_student_id ?>" class="text-warning"><i class="fas fa-shopping-basket"></i> Available Materials</a></li>
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 text-center">
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-street-view"></i> <strong> Available Materials</strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        while ($r = mysqli_fetch_assoc($q_assign_result )){
                                                            ...
                                                            while($row = mysqli_fetch_assoc($q_result)){
                                                                ...
                                                                <td class="text-center h4">
                                                                    <a href="s_download_material.php?id=<?php echo $row['class_id']; ?>"><i class="fas fa-download px-3"></i></a>
                                                                </td>

                                                                <td class="text-center h4">
                                                                    <a href="s_download_assignment.php?id=<?php echo $row['class_id']; ?>"><i class="fas fa-download px-3"></i></a>
                                                                </td>
