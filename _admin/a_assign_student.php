...
<html lang="en-us" dir="ltr">
  ...
  <body>
   ...
   <form action="a_assign_student.php" method="POST" class="p-4 bg-light">
            <?php 
            include '../my_funcs.php';
                if(isset($_POST['Submit'])){
                    ...
                    $student_id = $_POST['student_id'];
                        ...
                        $query = "INSERT INTO assign (class_id, student_id)
                                                VALUES ('$class_id', '$student_id')";

            
                        if(mysqli_query($con, $query)){
                            $msg = "You have Successfully Assigned a Student!";
                            echo $msg;
                        }
                }
        ...
        <!------  Select Class  ------->
                <div class="row mt-3 mb-3">
                    ...
                    <label for="select_class"><h6>Select Student</h6></label>
                    <?php  
                    
                    $q = "SELECT * FROM student";
                    $q_class = mysqli_query($con,$q);

                    echo "<select name='student_id' class='form-control' id='select_class'> ";
                    echo "<option selected>Choose...</option>";

                    while ($r = mysqli_fetch_assoc($q_class)){

                        echo "<option value = '{$r['student_id']}'";
                        echo ">{$r['student_full_name']}</option>";
                       }
                       echo "</select>";
                    ?>
