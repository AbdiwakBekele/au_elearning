  ...
  <body>
                            ...
                            <a href="#" class="col-md-3" style="text-decoration: none;">
                                <div class="card bg-warning text-dark">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <h5>
                                            <i class="fas fa-users"></i> <?php echo $teacher_count;?>
                                        </h5>
                                    </div>
                                </div>
                            </a>
    ...
    <div class="col-sm-12 col-md-8 offset-md-2"> 
        ...
        <!------- Teacher Registration Form ------->
   			...
   			<form class="was-validated bg-light border shadow p-3" action="a_add_teachers.php" method="POST" enctype="multipart/form-data" name="form">
            ...
            <?php
                ...
                if(isset($_POST['Submit'])){
                    ...
                    if($teacher_password == $confirm_teacher_password){
                                ...
                                $query = "INSERT INTO teacher (teacher_full_name, teacher_phone_no, teacher_gender, teacher_email, teacher_password)
                                                    VALUES ('$teacher_fullname', '$teacher_phone_no', '$teacher_gender', '$teacher_email', '$teacher_password')";

                                if(mysqli_query($con, $query)){
                                    $msg = "You have Successfully Registered a teacher!";
                                    echo $msg;
                                }
                ...
                <!-- Full Name Input -->
   				<div class="row mt-3">
					<div class="form-group col-md-12">
						...
						<input type="text" class="form-control" name="teacher_fullname" id="fullname" placeholder="Enter Your Full Name" required>
				...
				<div class="row mt-3">
					...
					<div class="form-group mt-2 col-md-6 col-sm-12">
						...
						<input type="email" class="form-control" name="teacher_email" id="email" placeholder="Enter Email id" required>
								<div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>  
					</div>
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        ...
                        <input type="phone" class="form-control" name="teacher_phone_no" for="mob_no" placeholder="Enter 10-digit Mobile no." maxlength="10" required>
