...
<html lang="en-us" dir="ltr">
  ...
  <body>
   ...
   <div class="col-sm-12 col-md-8 offset-md-2"> 
        ...
        <form class="was-validated bg-light border shadow p-3" action="a_add_students.php" method="POST" enctype="multipart/form-data" name="form">
                ...
                <?php
                    ...
                    if(isset($_POST['Submit'])){
                        ...
                        if($student_password == $confirm_student_password){
                            ...
                            $query = "INSERT INTO student (student_full_name, student_phone_no, student_gender, student_email, student_password)
                                                VALUES ('$student_fullname', '$student_phone_no', '$student_gender', '$student_email', '$student_password')";

                            if(mysqli_query($con, $query)){
                                $msg = "You have Successfully Registered a Student!";
                                echo $msg;
                            }
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <input type="phone" class="form-control" name="student_phone_no" for="mob_no" placeholder="Enter 10-digit Mobile no." maxlength="10" required>
