                                  ...
                                  <tbody>
                                    ...
                                    // Commented Section
                                        ...
                                        while($row = mysqli_fetch_assoc($q_result)){
                                            ...
                                            $row['teacher_id'],
                                            htmlspecialchars($row['teacher_photo']),
                                            htmlspecialchars($row['teacher_full_name']),
                                            htmlspecialchars($row['teacher_gender']),
                                            htmlspecialchars($row['teacher_email']),
                                            htmlspecialchars($row['teacher_phone_no'])
                                             );
                                    ?>
                                    <td class="text-center h4">
                                        <a href="t_view_api.php?id=<?php echo $row['teacher_id'] ?>"><i class="fas fa-address-card px-3"></i></a>
                                        <a href="t_edit_api.php?id=<?php echo $row['teacher_id'] ?>"><i class="fas fa-pencil-alt px-3"></i></a>
                                        <a href="t_delete_api.php?id=<?php echo $row['teacher_id'] ?>"><i class="fas fa-trash-alt px-3 text-danger"></i></a>
                                    </td>
