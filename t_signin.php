    ...
    <hr>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="was-validated border p-4 mb-4 bg-light shadow the_logo_form" action="t_signin_ctrl.php" method="post" name="form" onsubmit="return validated()">

                    <div class="mt-3 mb-3">
                        <label for="mail" class="form-lable"><i class="fas fa-envelope"></i> Email</label>
                        <input type="email" class="form-control" name="teacher_email" id="mail" placeholder="Enter Your Email" required="required">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" name="teacher_password" id="pswd" placeholder="Enter Your Password" required=""required>
                            <div class="valid-feedback">good</div>
                            <div class="invalid-feedback">fill-out</div>    
