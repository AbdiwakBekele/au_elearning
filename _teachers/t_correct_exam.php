		...
		<nav id="sidebar">
			<div class="p-4 pt-5">
    	        <ul class="list-unstyled components mb-5">
                    ...
                    <li><a href="t_correct_exam.php?id=<?php echo $temp_teacher_id ?>" class="text-warning"> <i class="fas fa-file-signature"></i> Correct Exam</a></li>
                    	...
                    	<div class="row align-items-center justify-content-center">
                        	<div class="col-md-6 text-center">
                                <div class="card bg-light col-md mt-1" style="border-style: none;">
                                    <div class="card-body">
                                        <h4 class="card-title"><i class="fas fa-street-view"></i> <strong>Correct Exams</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <thead>
                                                <tr class="h5 bg-primary text-white">
                                                    ...
                                                    <th class="text-center bg-dark" scope="col">Collect Exam</th>
                                                </tr>
                                            </thead>
                                            ...
                                            if (mysqli_num_rows($q_student_result) > 0) {
                                                ...
                                                ?>
                                                    <td class="text-center h4">
                                                        <a href="t_download_exams.php?id=<?php echo $assign_id ?>"><i class="fas fa-download px-3"></i></a>
                                                    </td>
                                                </tr>
