                    	...
                    	<div class="row align-items-center justify-content-center">
                        	<div class="col-md-6 text-center">
                                <div class="card bg-light col-md mt-1" style="border-style: none;">
                                    <div class="card-body">
                                        <h4 class="card-title"><i class="fas fa-street-view"></i> <strong>Upload Students Assignment</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    if(isset($_POST['Submit'])){
       ...
       // $query = "insert into product_items(product_img) values('".$name."')";
        ...
        move_uploaded_file($_FILES['class_assignment']['tmp_name'],$target_dir.$assignment_name);
            ...
            $query = "UPDATE class SET assignment = '$assignment_name' WHERE class_id = '$class_id' ";

            if(mysqli_query($con, $query)){
                $msg = "You have Successfully Uploaded a student Assignment!<br>";
                echo $msg;
...
<form class="was-validated bg-light border shadow p-3" action="t_upload_assignment.php" method="POST" enctype="multipart/form-data" name="form">
